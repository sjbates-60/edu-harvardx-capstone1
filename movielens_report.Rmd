...
many people over the course of several years, and my construction of several
...
-   Regularized movie and user effects and a nonregularized age effect;

-   Regularized movie, user, and age effects.

For each model, I calculated an optimal tuning parameter $\lambda$ for the
regularization and then averaged the results from 5-fold cross validation of the
...
$(e_1^u , … , e_{20}^u )$. The first vector is the genre categorization of movie
