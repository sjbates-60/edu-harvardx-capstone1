...
would have been that a user's rating of a comedy-romance had no relation to the
...
on the training set, listed in order of descending RMSE. The models that
included the `year` variable, shown in blue, produced identical results
regardless of whether the year was regularized. The models that performed best
included movie, user, and age effects. These still showed at most a
`r nongenre_improv`% improvement over the model with regularized movie and user
effects.
