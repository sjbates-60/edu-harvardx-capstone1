...
I also included a tuning factor in the model. Since the $e_g^u$ terms are
averages, I calculated the RMSE for $\lambda_2 \cdot \sum e_g^u$ for values of
$\lambda_2$ in a range, and chose the one that produced the lowest RMSE.
...
optimization, the calculation of 9 million ratings took roughly 80 minutes.
...
knitr::kable(model_results,
             ...
             caption = "Results of models executed on the training set")
```
