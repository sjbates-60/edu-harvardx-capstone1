...
model's predicted values from the actual values, and used the genre variables to
model the result.
...
estimate from the first phase. Again, I chose a linear combination of variables
for the model. As described above, I separated the `genres` variable into 20
