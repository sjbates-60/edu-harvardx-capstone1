...
year). I chose the month for the fraction rather than the day or week, as it
exhibited a smoother rate of change.
...
optimization, calculating the genre-based ratings took almost 3,000 times as
long as calculating the non-genre-based ratings.
